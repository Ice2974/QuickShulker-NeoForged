...
* QuickShulker: MIT, originally by kyrptonaught
* MoRanpcy/quickshulker: MIT, used as a reference for modern behavior, bug fixes, and features
* quickshulker-multi: MIT, used as a reference for multi-version project structure
