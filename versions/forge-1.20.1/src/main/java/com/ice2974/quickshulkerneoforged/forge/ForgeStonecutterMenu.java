...
public final class ForgeStonecutterMenu extends StonecutterMenu implements ForgeQuickOpenMenu {
    ...
    public ForgeStonecutterMenu(int containerId, Inventory inventory, ForgeShulkerSessionManager sessionManager, HostSlotRef hostSlotRef) {
