...
public final class NeoForgePlayerEnderChestContentAccess implements PlayerEnderChestContentAccess<Player, ItemStack> {
    @Override
    ...
    public ContentWriteResult writePlayerEnderChestContents(Player playerHandle, List<ItemStack> contents) {
        ...
        return ContentWriteResult.applied("Wrote player-scoped NeoForge ender chest contents back to the live inventory.");
    }
}
