...
public final class NeoForgeShulkerBundlingHelper {
    private static final ShulkerBundlingStackAdapter<ItemStack> STACK_ADAPTER = new ItemStackAdapter();

    private final NeoForgeShulkerContentAccess contentAccess;

    public NeoForgeShulkerBundlingHelper() {
        this(new NeoForgeShulkerContentAccess());
    }

    public NeoForgeShulkerBundlingHelper(NeoForgeShulkerContentAccess contentAccess) {
